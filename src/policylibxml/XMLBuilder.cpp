...
void
XMLBuilder::buildSchemaXMLForElement( xmlNodePtr parent, const std::string& name, const policylib::StateSchemaElement& elementData ) {
...
XMLBuilder::buildComplexTypeSchemaXML( xmlNodePtr parent, const std::string& name, const policylib::StateSchemaElement& elementData )   {
   ...
   typedef policylib::StateSchemaElement::PropertyTree::value_type value_type;
...
void
    XMLBuilder::buildSimpleTypeSchemaXML( xmlNodePtr parent, const std::string& name, const policylib::StateSchemaElement& elementData ) {
...
void
XMLBuilder::buildStateXMLForElement( xmlNodePtr parent, const std::string& name, const policylib::StateElement& elementData ) {
...
void
XMLBuilder::buildSimpleElementStateXML( xmlNodePtr node, const policylib::StateElement& elementData ) {
   xmlNodeAddContent( node, BAD_CAST elementData.getStringValue().c_str() );
}

void
XMLBuilder::buildComplexElementStateXML( xmlNodePtr node, const policylib::StateElement& elementData ) {
   const auto& ptree = elementData.getPropertyTree();

   typedef policylib::StateElement::PropertyTree::value_type value_type;
...
bool
XMLBuilder::elementLacksRestrictions( const policylib::StateSchemaElement& elementData ) const {
...
XMLBuilder::buildSimpleGuiLayout_alpha() {
   ...
   //             [row]( const std::pair<std::string, policylib::ElementData>& kv ) {
...
XMLBuilder::buildSimpleGuiLayout() {
   ...
   //   for_each( stateHash.begin(), stateHash.end(),
   //             [grid]( const std::pair<std::string, policylib::ElementData>& kv ) {
   //             auto row2 = xmlNewChild( grid, 0, BAD_CAST "row", 0 );
   //         auto cell0 = xmlNewChild( row2, 0, BAD_CAST "cell", 0 );
   //   auto key = xmlNewChild( cell0, 0, BAD_CAST "string", 0 );
   //   xmlSetProp( key, BAD_CAST "parameter", BAD_CAST kv.first.c_str() );
...
policylibxml::XMLBuilder::XMLBuilder(const std::vector<policylib::StateElement> &stateDelta,
...
void policylibxml::XMLBuilder::buildGUILayout(policylib::gui::Element *root,
                                              xmlNodePtr parent )
{
   ...
   case POPUP_BUTTON:
      addVisibilityKeys(addPopupButton(parent, dynamic_cast<policylib::gui::PopupButton*>(root)), root);
      break;
...
xmlNodePtr policylibxml::XMLBuilder::addPolicyGUIElement(policylib::gui::KeyValue *element,
...
xmlNodePtr policylibxml::XMLBuilder::addElementGroup(policylib::gui::ElementGroup *element,
                                                            xmlNodePtr parent)
{
...
xmlNodePtr policylibxml::XMLBuilder::addLayout(std::string type,
                                               policylib::gui::Container1D<policylib::gui::Element> *layout,
                                               xmlNodePtr parent)
{
...
xmlNodePtr policylibxml::XMLBuilder::addGridLayout(std::string type, policylib::gui::Grid *grid, xmlNodePtr parent)
{
...
xmlNodePtr policylibxml::XMLBuilder::addTabLayout(std::string type, policylib::gui::TabLayout *tabLayout, xmlNodePtr parent)
{
using namespace policylib::gui;
   auto element = xmlNewChild(parent, 0, BAD_CAST type.c_str(), 0);
...
xmlNodePtr policylibxml::XMLBuilder::addCanvas(policylib::gui::Canvas* element,
                                               xmlNodePtr parent)
{
...
xmlNodePtr policylibxml::XMLBuilder::addHorizontalLayout(policylib::gui::HorizontalLayout *layout, xmlNodePtr parent)
{
...
xmlNodePtr policylibxml::XMLBuilder::addVerticalLayout(policylib::gui::VerticalLayout *layout, xmlNodePtr parent)
{
...
xmlNodePtr policylibxml::XMLBuilder::addSpace(std::string type, xmlNodePtr parent)
{
   return xmlNewChild(parent, 0, BAD_CAST type.c_str(), 0);
}

xmlNodePtr policylibxml::XMLBuilder::addVisibilityKeys(xmlNodePtr xmlElement, policylib::gui::Element* element)
{
...
xmlNodePtr policylibxml::XMLBuilder::addElementKeys(xmlNodePtr xmlElementPtr,
                                              policylib::gui::KeyValue *element)
{
...
xmlNodePtr policylibxml::XMLBuilder::addPopupButton(xmlNodePtr parent, policylib::gui::PopupButton *button)
{
