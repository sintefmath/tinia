...
namespace {
class TestComputeJob1 : public jobcontroller::ComputeJob
{
public:
...
class ThrowingComputeJob : public jobcontroller::ComputeJob
{
public:
...
class CompletingComputeJob : public jobcontroller::ComputeJob
{
public:
