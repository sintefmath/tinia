...
class TestJob : public tinia::jobobserver::OpenGLJob, public tinia::policylib::StateListener
{
public:
    TestJob();
    ~TestJob();
    void stateElementModified(tinia::policylib::StateElement *stateElement);
    bool init();
